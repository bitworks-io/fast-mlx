...
- seven static `/capabilities/<id>/` detail permalinks, one per reviewed capability record, with
...
Capability detail permalinks are static readers over the exact seven reviewed capability records.
