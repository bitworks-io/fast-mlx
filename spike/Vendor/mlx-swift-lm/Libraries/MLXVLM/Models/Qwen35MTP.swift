...
package final class Qwen35VLMNextNDraftModel: Module, StatefulMTPDrafterModel {
    ...
    public func supportsSpeculation(for input: LMInput) -> Bool {
    ...
    public func sanitize(weights: [String: MLXArray]) -> [String: MLXArray] {
        qwenMTPSanitizeWeights(
            ...
            normalizeBareArtifactKeys: preconvertedNorms
        )
    }
}
