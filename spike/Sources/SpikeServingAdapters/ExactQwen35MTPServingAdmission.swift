...
public enum ExactQwen35MTPServingAdmissionPolicy {
    ...
    private static func reviewedLock(
        ...
        case .qwen38_27B4BitDepth1:
            // Serving admission stays open as parallel infrastructure, but the 4-bit quality
            // gate resolved NO-GO on 2026-09-01 (frozen band; see the quality-gate design
            // record's OUTCOME section): this row is quality-refused relative to the mxfp8
            // incumbent and must not be promoted, deployed, or represented as
            // quality-endorsed. Selecting it serves measurement/diagnostic use only.
