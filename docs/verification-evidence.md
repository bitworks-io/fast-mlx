...
speed gate. Qwen 32K runtime/capacity evidence, separate KVarN capacity-only context, and the
authenticated near-128K refusal remain pending before the Qwen model-scoped frontier can close.
