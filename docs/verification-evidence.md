...
floor. The current next model-family candidate is Phi-4-mini's Phi3 Q24/KV8/D128 geometry, which
still requires independent source, registry/load, runtime, quality, and failure-path proof.
