...
so 32K speed evidence is hardware-unavailable under the frozen unthrottled contract. Separate
KVarN capacity-only context and the authenticated near-128K refusal remain pending before the Qwen
model-scoped frontier can close.
