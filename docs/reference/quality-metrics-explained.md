...
*(The underlying baseline receipts remain in the non-public engineering evidence ledger. Public
rationale: [teacher forcing](../content/2026-07-09-trusting-the-instrument.md) and
[tail statistics](../content/2026-07-09-the-wall-that-wasnt.md).)*
